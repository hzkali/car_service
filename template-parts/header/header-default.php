...
$header_button_text = autixir_get_options( 'header_button_text' );
$header_button_url = autixir_get_options( 'header_button_url' );
                ...
                <div class="row">
                    ...
                    <div class="col header-menu-column menu-color-white">
                        <div class="header-menu d-none d-xl-block">
							...
							<?php if(!empty($header_button_url) && !empty($header_button_text)){?>
							<div class="special-link"><a href="<?php echo esc_url($header_button_url);?>"><?php echo esc_html($header_button_text);?></a></div>
							<?php } ?>
                        </div>
